angular.module('ProjectCtrl', []).controller('ProjectController', ['$scope', function($scope){
  ...
  {title:"Jimmy Bob's Car-a-palooza", description:"This stemmed from a project for my Introductions to Database Class, CS431. The design specification was for a simple POS unit for a car dealership to handle customer sales. My friend Trevor and I took it a bit farther, and decided to implement some technologies extra technologies for practice. The front end is written as a single page application in AngularJS, where the backend is a Laravel setup, using MySQL database.", imageURL:'/assets/JimmyBob.png', link:'https://github.com/tsums/CarSalesProject'},
